...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Sidebar */}
      <aside className={cn(
        "fixed inset-y-0 left-0 z-40 w-72 bg-white border-r border-slate-200 transform transition-transform duration-300 ease-out lg:translate-x-0",
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="px-4 mt-4 lg:mt-0">
            <Link to={createPageUrl('Home')}>
              <Button className="w-full bg-indigo-500 text-white h-12 rounded-xl font-medium">
